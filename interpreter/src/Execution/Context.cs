...
public class Context
{
    ...
    private readonly Dictionary<string, FunctionDecl> functions = [];
    ...
    {
        if (!functions.TryGetValue(name, out FunctionDecl? func) )
        {
    ...
    public void DefineFunction(FunctionDecl function)
    {
