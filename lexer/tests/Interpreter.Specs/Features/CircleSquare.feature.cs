...
#line hidden
#line 8
    await testRunner.WhenAsync("I execute the program:", "let r: int = readNumber();\r\nlet area: int = Pi * r ** 2;\r\nprint(area);", ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 14
    await testRunner.ThenAsync("I should get the output:", "78.53982", ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
